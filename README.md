...
2. Download your entire website as a folder. Copy the entire site folder, and paste it into the new folder you created.
...
6. Run generateFS.js using the command:
   ...
   ```node generateFS.js ```
9. Copy the contents of the file "filesystem.json" it generates. This file will be inside of the public folder.
...
V3 will have a different json file, and will also hopefully improve the go command to allow for different files to be opened.
